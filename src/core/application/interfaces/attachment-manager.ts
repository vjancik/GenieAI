...
export interface IAttachmentManager {
     ...
     */
    getAttachmentStream(attachment: MessageAttachment, messageId: string): Promise<{
     ...
     */
    updateAttachmentMetadata(messageId: string, attachmentId: string, metadata: Partial<MessageAttachment>): Promise<void>;
}
